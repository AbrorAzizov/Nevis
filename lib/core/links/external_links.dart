...
class ExternalLinks {
  ...
  static final String bonusProgrammUrl =
      '${_baseUrl}instruction/programma-loyalnosti-vasha-karta-cashback/';
  static final String orderInstructionUrl =
      '${_baseUrl}instruction/instruktsiya-po-oformleniyu-zakaza-na-sayte/';
  static final String privacyPolicyUrl =
      '${_baseUrl}instruction/personal-data/';
  static final String bookingRulesUrl =
      '${_baseUrl}instruction/pravila-bronirovaniya-i-dostavki/';
  static final String userAgreement =
      '${_baseUrl}polzovatelskoe-soglashenie.php';
}
