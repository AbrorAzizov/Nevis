...
class FavoriteProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          FavoriteProductsScreenBloc()..add(LoadProductsEvent()),
      child:
          BlocBuilder<FavoriteProductsScreenBloc, FavoriteProductsScreenState>(
  ...
  Widget _buildBody(
      FavoriteProductsScreenState state, FavoriteProductsScreenBloc bloc) {
    if (state.isLoading) {
